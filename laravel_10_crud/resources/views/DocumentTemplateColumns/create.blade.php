...
@section('content')
    ...
    <form action="{{ route('documentTemplateColumns.store') }}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="column_type_id" class="form-control" placeholder="Код поля из таблицы columns">
                </div>
            </div>
